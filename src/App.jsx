...
// Also fixed for mobile: responsive padding, margins, and max-height
    ...
    {isOpen && (
      <>
        ...
        <motion.div
          ...
          className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-charcoal border-2 border-casino-gold rounded-xl p-4 sm:p-8 max-w-2xl w-[calc(100%-2rem)] sm:w-full max-h-[85vh] overflow-y-auto z-50"
        >
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="bg-charcoal-dark p-4 sm:p-6 rounded-lg border border-casino-gold">
            ...
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              ...
              <span className="text-xl sm:text-2xl font-bold text-casino-gold">${balance}</span>
            </div>
            <Button
              onClick={() => {
